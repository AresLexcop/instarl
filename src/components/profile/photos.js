                    ...
                    photos.map((photo) => 
                        <div key={photo.docId} className="relative group" >
                            <img
                                ...
                                alt={photo.caption}
                            />
                            <div className="absolute bottom-0 left-0 bg-green-200 z-10 w-full justify-evenly 
                            items-center h-full bg-black-faded group-hover:flex hidden">
                                ...
                                <p className="flex items-center text-white font-bold">
                                    ...
                                    <path
                                        ...
                                        11.434 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7zM7 
                                        9H5v2h2V9zm8 0h-2v2h2V9zM9 9h2v2H9V9z"
                                        clipRule="evenodd"
                                    />
                                    </svg>
